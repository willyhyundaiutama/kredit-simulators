  ...
  return (
    <div className="w-full">
      <div className="glass-card dark:glass-card-dark p-6 rounded-2xl">
        ...
        {!isExpanded && (
          <div className="p-4 bg-gray-50 dark:bg-gray-800/30 rounded-lg flex flex-col md:flex-row justify-between gap-4 animate-fade-in">
            <div className="flex items-center justify-between">
              <span className="text-sm font-medium text-gray-500 dark:text-gray-400">Angsuran per bulan:</span>
              <span className="font-bold text-lg text-primary ml-2">{formatRupiah(results.monthlyInstallment)}</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-sm font-medium text-gray-500 dark:text-gray-400">Total DP:</span>
              <span className="font-bold text-lg text-primary ml-2">{formatRupiah(results.totalDp)}</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-sm font-medium text-gray-500 dark:text-gray-400">Tenor:</span>
              <span className="font-bold text-lg ml-2">{tenor} tahun</span>
            </div>
          </div>
        )}
